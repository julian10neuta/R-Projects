...
"De acuerdo con un artículo de una revista importante, aproximadamente 30% de 
todas las fallas de operación en las tuberías de plantas químicas son 
ocasionadas por errores del operador.

  1. ¿Cuál es la probabilidad de que de las siguientes 20 fallas en las 
  tuberías al menos 10 se deban a un error del operador?
  2. ¿Cuál es la probabilidad de que no más de 4 de 20 fallas se deban a un 
  error del operador?"
###############################################################################
library(ggplot2)
...
"Suponga que los motores de un avión operan de forma independiente y que tienen
una probabilidad de falla de 0.4. Se supone que un avión tiene un vuelo seguro 
si funcionan al menos la mitad de sus motores. Si un avión tiene 4 motores y 
otro tiene 2, ¿cuál de los dos tiene la probabilidad más alta de un vuelo 
exitoso?"
###############################################################################
...
"Para evitar la detección en la aduana, un viajero coloca 6 comprimidos con 
narcóticos en una botella que contiene 9 píldoras de vitamina que aparentemente 
son similares. Si el oficial de la aduana selecciona 3 de las tabletas al azar 
para su análisis, ¿cuál es la probabilidad de que el viajero sea arrestado por 
...
"Se selecciona al azar un comité de 3 personas a partir de 4 médicos y 2 
enfermeras. Escriba una fórmula para la distribución de probabilidad de la 
variable aleatoria $X$ que representa el número de médicos en el comité. 
Calcule $P(2 ≤ X ≤ 3)$"
###############################################################################
...
"De un lote de 10 misiles, se seleccionan 4 al azar y se disparan. Si el lote 
contiene 3 misiles defectuosos que no pueden dispararse, 
...
"En cierto crucero ocurren, en promedio, 3 accidentes de tránsito al mes. 
¿Cuál es la probabilidad de que en cualquier determinado mes en este crucero
...
considerable. Los índices de llegadas los aviones son factores importantes que 
...
hora. De esta manera, el parámetro de Poisson para las llegadas en un periodo 
de horas es μ = 6t.

  1. ¿Cuál es la probabilidad de que lleguen exactamente 4 aviones pequeños 
  durante un periodo de una hora?
  2. ¿Cuál es la probabilidad de que lleguen al menos 4 durante un periodo de 
  una hora?
  3. Si definimos un día laboral como de 12 horas, ¿cuál es la probabilidad de 
  que al menos 75 aviones pequeños lleguen durante un día laboral?"
###############################################################################
